...
int main(int argc, char** argv) {
	...
	int block_slider = 6;
	createTrackbar("Block size", "Disparity", &block_slider, 127);
	...
	while(true)
	{
		...
		{
			block_estimation=getTrackbarPos("Block size", "Disparity")*2+1;
		...
		if (iKey == 1048603) // ENG keyboard = 27, DANISH keyboard = 1048603
			{
